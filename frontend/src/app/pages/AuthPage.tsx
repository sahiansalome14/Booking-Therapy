        ...
        <div className="relative z-10 w-full flex flex-col justify-center px-20">
          <div className="mb-12">
            ...
            <p className="text-xl text-white/90 font-medium max-w-md leading-relaxed">
              Tu puerta de entrada a una red de profesionales comprometidos con tu equilibrio y salud integral.
            </p>
          </div>

          <div className="space-y-8">
            {[
              { icon: ShieldCheck, text: 'Privacidad absoluta en tus sesiones' },
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative overflow-hidden">
        ...
        <div className="max-w-md w-full animate-fade-in-up">
          <div className="text-center mb-10 lg:hidden">
            <h2 className="text-3xl font-black text-primary tracking-tighter">Vis Vitalis</h2>
          </div>

          <div className="mb-8">
            <h3 className="text-4xl font-extrabold tracking-tight mb-2">Comienza ahora</h3>
            <p className="text-muted-foreground font-medium">Inicia sesión o crea tu cuenta para continuar</p>
          </div>
          ...
          <Card className="p-8 shadow-2xl border-border/50 bg-card/50 backdrop-blur-sm rounded-3xl overflow-hidden relative group">
            ...
            <Auth
              ...
              appearance={{
                ...
                className: {
                  button: 'hover:scale-[1.02] active:scale-[0.98] transition-all font-bold shadow-md',
                  input: 'bg-muted/50 border-none focus:ring-2 focus:ring-primary/20 transition-all',
                }
              }}
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground font-medium">
            Al continuar, aceptas nuestros <a href="#" className="underline hover:text-primary transition-colors">Términos de Servicio</a> y <a href="#" className="underline hover:text-primary transition-colors">Política de Privacidad</a>.
          </p>
        </div>
      </div>
