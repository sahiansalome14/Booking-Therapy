...
import { Calendar, Heart, Shield, TrendingUp, Sparkles, Zap, Activity, ArrowRight, MousePointer2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-8 bg-card/80 backdrop-blur-xl border border-border shadow-2xl rounded-[2.5rem]">
          {[
            ...
            <div key={i} className="text-center group">
              <p className="text-3xl font-black text-primary group-hover:scale-110 transition-transform">{stat.val}</p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-24">
            <div className="inline-flex items-center gap-2 bg-primary/5 px-4 py-2 rounded-full mb-6 border border-primary/10">
              ...
              <span className="text-sm font-bold text-primary uppercase tracking-tighter">Ecosistema Profesional</span>
            </div>
            <h2 className="text-5xl font-black mb-6 tracking-tight">
              Diseñado para el <span className="text-primary italic">Máximo</span> Desempeño
            </h2>
            <p className="text-muted-foreground text-xl max-w-2xl mx-auto leading-relaxed font-medium">
              Simplificamos la burocracia para que te enfoques en lo que importa: tu proceso de sanación o tu práctica clínica.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Agenda automatizada con sincronización en tiempo real y recordatorios.',
                gradient: 'from-blue-600 to-indigo-600'
              },
              {
                icon: Shield,
                title: 'Seguridad de Grado Militar',
                description: 'Tus datos clínicos y financieros protegidos bajo los estándares más altos.',
                gradient: 'from-cyan-500 to-blue-500'
              },
              {
                icon: Heart,
                title: 'Cuidado Humanizado',
                description: 'Priorizamos la conexión humana en cada interacción digital.',
                gradient: 'from-teal-500 to-emerald-500'
              },
              {
                icon: TrendingUp,
                title: 'Analíticas de Progreso',
                description: 'Visualiza tu evolución emocional y física de manera profesional.',
              ...
              >
                <div className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-10 group-hover:rotate-6 transition-all duration-500 shadow-xl shadow-primary/20`}>
                ...
                <div className="mt-8 flex items-center text-primary font-bold group-hover:gap-2 transition-all">
                  Saber más <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100" />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 bg-muted/30 relative">
        <div className="container mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-5xl font-black mb-6 tracking-tight">Tres Pasos al Éxito</h2>
            <p className="text-muted-foreground text-xl">Tu transformación comienza hoy.</p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Encuentra el especialista que mejor se adapte a tu perfil energético.',
                  color: 'text-blue-600'
                },
                {
                  number: '02',
                  title: 'Reserva Segura',
                  description: 'Confirma tu sesión con pasarelas de pago cifradas de extremo a extremo.',
                  color: 'text-cyan-600'
                },
                {
                  number: '03',
                  title: 'Evoluciona',
                  description: 'Accede a tu sesión y gestiona tu historial clínico con un clic.',
                  color: 'text-teal-600'
                }
              ].map((step, index) => (
                <div key={index} className="text-center group">
                  <div className={`text-7xl font-black ${step.color} opacity-10 mb-[-40px] group-hover:opacity-20 transition-opacity`}>
                    {step.number}
                  </div>
      ...
      <section className="py-24 container mx-auto px-6">
        <div className="relative rounded-[3rem] p-12 md:p-24 overflow-hidden shadow-glow">
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto text-white">
            <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">¿Listo para liberar tu Potencial Vital?</h2>
            <p className="text-xl md:text-2xl mb-12 text-blue-10 font-medium opacity-90 leading-relaxed">
              Únete a la mayor red de bienestar profesional y comienza a vivir con intención.
            </p>
            <Link to="/search">
              <Button
                size="lg"
