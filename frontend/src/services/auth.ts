 ...
 */
export async function signup(email: string, password: string, role: 'client' | 'therapist'): Promise<AuthResponse> {
  try {
    ...
    throw {
      message: error.response?.data?.message || error.message || 'Error en signup',
